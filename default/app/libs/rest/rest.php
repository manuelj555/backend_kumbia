...
class Rest{
	...
	/**
	 * Cadena que describe el error producido
	 */
	protected static $s_error = null;
	
	
	
	private static $code = array(
		201 => 'Success', /*Se ha creado un nuevo recuerso (INSERT)*/
	...
	static public function init(){
		...
		if(self::$oFormat== null){
			self::$s_error = 'Not support the format request';
			return 'error';
		}else{
